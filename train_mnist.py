...
def train(net, optimizer, loader, epochs):
...
if __name__=='__main__':
  ...
  parser.add_argument('--batch_size', type=int, default = '5', help='baych_size')
  parser.add_argument('--lr', type=float, default = '1', help='learning_rate')
